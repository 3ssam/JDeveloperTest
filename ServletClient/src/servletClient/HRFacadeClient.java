...
import oracle.model.Departments;
import oracle.model.Employees;
import oracle.model.HRFacade;
...
public class HRFacadeClient {
    public static void main(String[] args) {
        try {
            ...
            for (Employees employees : (List<Employees>) hRFacade.getEmployeesFindByName("P%") ) {
                printEmployees(employees);
            }
